...
- Encryption <span>At Rest</span>
  - Client-Side Encryption: by user (after encrypting by user, and then upload objects to S3)
...
- <span>Eventual</span> consistency
  ...
  - = when overwrite or delete an object, it takes time to replicate versions to AZs.
